    ...
    return (
        <div class={"fixed inset-x-0 bottom-0  h-[20dvh] w-full flex justify-center items-center sm:max-w-sm"}>
            ...
            <div
                ...
                <button
                    class={"absolute  rounded-full left-[10%] bottom-[34.3%] h-[2rem] w-[2rem] sm:h-[2.2rem] sm:w-[2.2rem]"}
                ...
                <button
                    class={"absolute  rounded-full left-[28.4%] bottom-[34.3%] h-[2rem] w-[2rem] sm:h-[2.2rem] sm:w-[2.2rem]"}
                ...
                <button
                    class={"absolute  rounded-full left-[47.2%] bottom-[34.3%] h-[2rem] w-[2rem] sm:h-[2.2rem] sm:w-[2.2rem]"}
                ...
                <button
                    class={"absolute  rounded-full right-[26.225%] bottom-[34.3%] h-[2rem] w-[2rem] sm:h-[2.2rem] sm:w-[2.2rem]"}
                ...
                <button
                    class={"absolute  rounded-full right-[8%] bottom-[34.3%] h-[2rem] w-[2rem] sm:h-[2.2rem] sm:w-[2.2rem]"}
