...
const Strength: Component<PROPS> = props => {
        ...
        <div>
            <div class={styles["cardContainer"]}>
                <div class={`${styles["cardItem"]} ${styles["button"]}`}>
                    ...
                    <img src="/src/static/perks/images/ui/strong-back.webp" alt={""}/>
                    <p>Strong Back</p>
                    <ul>
                ...
                <div class={`${styles["cardItem"]} ${styles["button"]}`}>
                    ...
                    <ul>
                        ...
                        <li class={styles["levelReq"]}>Level Req: <span class={styles["levelGlow"]}>3+</span></li>
                ...
                <div class={`${styles["cardItem"]} ${styles["button"]}`}>
                    ...
                    <ul>
                        ...
                        <li class={styles["levelReq"]}>Level Req: <span class={styles["levelGlow"]}>4</span></li>
                        <li>Other Req: <span class={styles["perkGlow"]}>Strength 7, No robot origin</span></li>
                        <li>Ranks: 1</li>
                    </ul>
                </div>
                <div class={`${styles["cardItem"]} ${styles["button"]}`}>
